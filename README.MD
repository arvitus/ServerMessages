...
| Translation Key(s)                  |                                                                                                                             Context                                                                                                                             |
|-------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|
| `chat.type.advancement.*`           |                                                                                                                            `player`                                                                                                                             |
| `commands.kick.success`             |                                                                                                                            `player`                                                                                                                             |
| `death.*`                           |                                                                                                                            `player`                                                                                                                             |
| `multiplayer.disconnect.*`          | `player` if the player was already on the server before the disconnect, otherwise `profile`.<br/><br/>**Exceptions (non-exhaustive list)**<br/>`.transfers_disabled`, `.outdated_client`, `.incompatible`<br/>*These only have the default context (`server`).* |
...
| Translation Key                        | Context  | Notes                                                                                                                                                                                                                                                                          | Default |
|----------------------------------------|:--------:|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------|
| `multiplayer.disconnect.kicked.reason` | `player` | Sent to the kicked player(s), if there was a reason specified.<br/><br/>*The reason is the only argument (`%s`).*<br/>*See [`multiplayer.disconnect.banned.reason`](https://github.com/InventivetalentDev/minecraft-assets/blob/26.1/assets/minecraft/lang/en_us.json#L5596).* | `%s`    |
