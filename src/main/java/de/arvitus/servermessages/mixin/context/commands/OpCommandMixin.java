...
public class OpCommandMixin {
    @WrapMethod(method = "lambda$opPlayers$0")
    private static Component setFeedbackContext(NameAndId player, Operation<Component> original) {
        ...
        return ServerMessages.withContext(ServerPlaceholderContext.of(serverPlayer), () -> original.call(player));
    }
}
